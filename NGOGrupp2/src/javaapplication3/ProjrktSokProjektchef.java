 ...
 * @author WDM
 */
public class ProjrktSokProjektchef extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ProjrktSokProjektchef.class.getName());
    ...
    /**
     * Creates new form ProjrktSokProjektchef
     */
    public ProjrktSokProjektchef(Anvandare anvandare) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        //Sjava.awt.EventQueue.invokeLater(() -> new ProjrktSokProjektchef().setVisible(true));
    }
